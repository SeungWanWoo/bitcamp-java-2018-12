...
@Controller
@RequestMapping("/c04_5") // 컨트롤러에 URL을 매핑한다.
public class Controller04_5 {
  ...
  // 테스트:
  // .../c04_5/h1?model=sonata&capacity=5&auto=true&createdDate=2019-4-19
  @GetMapping("h1")
  @ResponseBody
  ...
  //테스트:
  // .../c04_5/h2?car=sonata,5,true,2019-4-19
  @GetMapping("h2")
  @ResponseBody
  ...
  //테스트:
  // .../c04_5/h3?engine=bitengine,3500,16
  @GetMapping("h3")
  @ResponseBody
