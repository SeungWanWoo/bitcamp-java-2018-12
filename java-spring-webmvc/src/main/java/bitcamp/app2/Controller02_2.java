...
public class Controller02_2 {
  ...
  public String handler2(
      ...
      // 단, value의 형식은 "이름=값;이름=값;" 형태여야 한다.
...
//      @MatrixVariable("age") int age
    ...
    // => <mvc:annotaion-driven enable-matrix-variables="true"/>
    ...
    // 테스트2
    //  .../app2/c02_2/user;name=kim;age=20
    // => @PathVariable("value") value : user
  ...
  //테스트:
  //    .../app2/c02_2/name=teamA;qty=5/title=work1;state=1
  ...
  //테스트:
  //    .../app2/c02_2/name=teamA;qty=5/name=work1;qty=1
