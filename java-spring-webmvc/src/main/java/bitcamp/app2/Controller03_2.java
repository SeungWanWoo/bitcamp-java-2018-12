...
// 세션에 해당 값이 들어 있어도 @ModelAttribute가 붙은 아규먼트에 값을 넣어주지 않는다.
...
public class Controller03_2 {
  ...
  public String handler3(
      ...
      // => 만약에 요청 파라미터에 tel2가 있다면 그 값을 넣어준다.
  ...
  //테스트:
  //    1) .../app2/c03_1/h1 을 실행하여 name과 age 값을 세션에 보관한다.
  //    2) .../app2/c03_2/h1 을 실행하여 name2와 age2 값을 세션에 보관한다.
  //    3) .../app2/c03_2/h4 을 실행하여 세션에 보관된 값을 꺼낸다.
  ...
  public String handler4(
      ...
      // => 왜?
      //    @ModelAttribute는 현재 페이지 컨트롤러의 @SessionAttributes에 지정된 이름에
      //    한해서만 세션에서 값을 꺼내기 때문이다.
      //
      @ModelAttribute("name") String name,
      @ModelAttribute("age") String age,

      // c03_2/h1 에서 세션에 저장한 값 꺼내기
      @ModelAttribute("name2") String name2,
      @ModelAttribute("age2") String age2) {
