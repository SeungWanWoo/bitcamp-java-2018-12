// JSON 콘텐트 입력받기 - MapListController
...
public class Controller05_3 {
  ...
  public Object handler4(@RequestBody Map<String,Object> content) {
    System.out.println(content);
    return "OK!";
  }
