...
@Controller
@RequestMapping("/c04_3") // 컨트롤러에 URL을 매핑한다.
public class Controller04_3 {

  // 클라이언트가 보낸 파라미터 값을 값 객체에 받을 수 있다.
  ...
  // 테스트:
  // .../c04_3/h1?model=sonata&maker=hyundai&capacity=5&auto=true
  @GetMapping("h1")
  @ResponseBody
  public void handler1(
      ...
      String model,
      String maker,
      int capacity, // 프론트 컨트롤러가 String 값을 int로 변환해준다.
                    // 단, 변환할 수 없을 경우 예외가 발생한다.
      boolean auto, // 프론트 컨트롤러가 String 값을 boolean으로 변환해준다.
                    // 단, 변환할 수 없을 경우 예외가 발생한다.
                    // "true", "false"는 대소문자 구분 없이 true, false로 변환해준다.
                    // 1 ==> true, 0 ==> false로 변환해준다. 그외 숫자 예외 발생
