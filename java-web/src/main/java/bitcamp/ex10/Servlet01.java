...
Set-Cookie: name2=홍길동       <----URLEncoding 하지 않은 예
Set-Cookie: name3=%ED%99%8D%EA%B8%B8%EB%8F%99 <----URLEncoding 한 예
Content-Type: text/plain;charset=UTF-8
Content-Length: 35
Date: Wed, 03 Apr 2019 01:03:39 GMT
     */
    //
    // 쿠키 생성
    // => 이름과 값으로 생성한다.
    // => 쿠키의 유효기간을 설정하지 않으면 웹 브라우저가 종료될 때 까지 유지된다.
    //    웹 브라우저를 종료하면 웹서버로부터 받은 유효기간이 지정되지 않은 쿠키는 모두
    //    삭제된다.
    ...
    //    ASCII코드화시켜 보내야 한다.
    Cookie c4 = new Cookie("name2", "홍길동"); // => 이렇게 보내면 안된다.
