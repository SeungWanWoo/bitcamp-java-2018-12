...
Set-Cookie: v2=bbb; Path=/java-web/ex10/a       <-- 사용 범위가 /java-web/ex10/a로 제한되었다.
Set-Cookie: v3=ccc; Path=/java-web            <-- 사용 범위가 /java-web/*으로 제한되었다.
Content-Type: text/plain;charset=UTF-8
Content-Length: 36
Date: Wed, 03 Apr 2019 02:05:47 GMT
 */
    // 사용 범위를 지정하지 않은 쿠키
    ...
    //    '/'로 던지기 때문이다.
    // => 그래서 쿠키의 경로를 지정할 때는 웹 애플리케이션 루트(컨텍스트 루트)를 정확하게
    //    지정해야 한다.
    //
    // 쿠키를 응답헤더에 포함시키기
