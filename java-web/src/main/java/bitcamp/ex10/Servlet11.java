...
public class Servlet11 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response) 
    ...
    //
    // 쿠키 유효기간
    // => 유효기간을 설정하면 그 기간 동안에만 웹서버에 쿠키를 보낸다.
    // => HTTP 응답 프로토콜
    /*
HTTP/1.1 200
Set-Cookie: v1=aaa  <-- 유효기간이 설정되지 않은 쿠키
Set-Cookie: v2=bbb; Max-Age=30; Expires=Wed, 03-Apr-2019 01:33:39 GMT
Set-Cookie: v3=ccc; Max-Age=60; Expires=Wed, 03-Apr-2019 01:34:09 GMT
Content-Type: text/plain;charset=UTF-8
Content-Length: 36
Date: Wed, 03 Apr 2019 01:33:09 GMT
     */
    // 유효기간을 설정하지 않으면 웹 브라우저가 실행되는 동안에만 웹서버에게 쿠키를 보낸다.
