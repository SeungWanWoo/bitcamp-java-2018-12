...
public class Servlet01 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response) 
    ...
    //    고유 번호를 발급(쿠키 이용)한다.
    //    이 고유 번호를 '세션아이디(Session ID)'라 부른다.
    // => 웹 브라우저는 세션아이디를 보관해 두었다가 그 서버에 요청할 때마다 
    //    세션 아이디를 보낸다.
    //    왜? 세션 아이디는 쿠키이다.
    // => 세션 아이디 쿠키는 기본 유효 기간을 설정하지 않았기 때문에 
    //    웹 브라우저를 종료하면 세션 아이디 쿠키는 삭제된다.
    // => 세션 아이디 쿠키의 사용범위는 웹 애플리케이션이다.
    //    예) /java-web
...
/*
HTTP/1.1 200
Set-Cookie: JSESSIONID=8E03DE89EFB6FCA0150431FD9C702EEA; Path=/java-web; HttpOnly
...
*/
    ...
    //    - 있으면, 그 세션을 리턴한다.
    //    - 있는데 세션의 유효기간이 지난 세션 객체라면 새로 세션을 만들어 리턴한다.
    //    - 없다면 새로 세션을 만들어 리턴한다.
