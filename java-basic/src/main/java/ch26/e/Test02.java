// sql 실행할때 파라미터 값 넘기기 II - 도메인 객체 넘기기
package ch26.e;
...
public class Test02 {
  public static void main(String[] args) throws Exception {
    ...
    // insert 문을 실행할 때는 insert() 메서드를 설정하라.
    ...
    // 주의!
    // => mybatis는 auto_commit이 false이다.
    // => 데이터 변경(insert/update/delete) 작업을 수행한 후 반드시 commit()을 호출
    //    해야 한다.
    sqlSession.commit();
