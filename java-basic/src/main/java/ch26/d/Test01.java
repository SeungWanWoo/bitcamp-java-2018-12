...
public class Test01 {
  public static void main(String[] args) throws Exception {
    ...
    // => select 실행으로 생성된 각 row의 값은 
    //    resultType에 지정한 클래스의 인스턴스에 저장된다.
    ...
    // => 만약 여러 개의 결과가 리턴되는 select문을 실행한다면 예외가 발생한다.
    //    - TooManyResultsException
    
    // board.select1 SQL 문은 여러 개의 결과값이 리턴되기 때문에 실행중 오류가 발생한다.
    // selectOne()으로 실행해서는 안된다.
    // 실행중 오류가 발생한다. => selectList()를 실행해야 한다.
