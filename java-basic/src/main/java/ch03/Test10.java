...
public class Test10 {
  public static void main(String[] args) {
    ...
    /*
    * nextInt -> nextLine을 사용하는 행위는 키보드에서 입력한 값을 
    * 바로 리턴한다 라는 의미이다. 그러나 사실상 불가능하다.
    * 왜? 기본적으로 소프트웨어는 하드웨어에 직접 접근할 수 없기 때문이다.[장치 드라이버 제외]
