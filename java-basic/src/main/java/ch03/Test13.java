...
public class Test13 {
  public static void main(String[] args) {
    ...
    // 2) 레퍼런스 변수를 선언할 때 동시에 배열 생성하기
    int[] arr2 = new int[5];
    
    // 3) 레퍼런스 변수를 선언할 때 배열 생성과 값을 초기화시키기
    // => 초기 값을 설정할 때는 배열의 개수를 지정하면 안된다 => 컴파일 오류!
    // =>int[] arr3 = new int[5] {100, 100, 90, 90, 60}; (X)
    ...
    //Array constants can only be used in initializers! 컴파일 오류
