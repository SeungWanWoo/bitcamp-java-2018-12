...
public class Test06 {
  ...
  public static void main(String[] args) {
    ...
    // => toString()의 해시값과 동일하다는 것을 알 수 있다.
    ...
    //   다만 확률이 얼마나 낮은가의 문제다.
    //   즉, 다른 데이터에 대해 같은 정수 값이 나올 확률이 낮을 수록 안심하고 사용할 수 있다.
    // - 현실과 비교하면 주민번호와 같다.
    //   본인 여부를 확인할 때 주민 번호로 확인하면 매우 빠르게 결과를 알 수 있다.
    //   만약 원래는 본인인지 알아내려면 DNA 검사를 해야한다.
    //   그러면 너무 시간이 오래 걸린다. 그런데 지문이나 주민번호를 사용하면 빠르게 본인 여부를
    //   알 수 있다.
