...
public class Test02 {
  public static void main(String[] args) {
    ...
    // => 파라미터가 있는 메서드를 호출하려면 
    // 반드시 그 파라미터가 원하는 타입의 값을 넘겨줘야 한다.
    //m1(); // 컴파일 오류! 문자열과 정수값을 줘야하는데 안줌!
    
    // 파라미터에 값을 전달할 때 반드시 순서를 지켜야 한다.
    //m1(20, "홍길동"); // m1 메서드의 파라미터 순서는 String, int인데
    // 위의 메서드 호출에서는 int, String 순으로 값을 넣어줬기 때문에 컴파일 오류!
  ...
  // 그 값을 담을 변수를 메서 정의에 선언해야 한다. => name, age
