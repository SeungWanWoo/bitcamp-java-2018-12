// 예외 처리 - try-with-resources 문법 : 사용전
...
public class Test01 {
  public static void main(String[] args) {
    ...
    // 자바에서 제공하는 자원들 중에는 쓰고 난 다음에 해제시켜야하는 자원이 있다.
    // 보통 파일이나 네트워크 입출력, DB 연결과 같은 한정된 자원이다.
    ...
    // StringWriter 역할 - 출력된 것을 문자열로 가지고 있는다.
    ...
    try {
      ...
      try {
        ...
        // 그래서 예외를 받기만하고 특별히 뭔가를 수행하지 않는다.
      }
