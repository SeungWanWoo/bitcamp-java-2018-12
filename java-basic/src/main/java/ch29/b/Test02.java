  ...
  public static void main(String[] args) {
    ApplicationContext iocContationer =
        new ClassPathXmlApplicationContext(
            "ch29/b/application-context-02.xml");
    ...
    Car c6 = (Car) iocContationer.getBean("c6");
    Car c7 = (Car) iocContationer.getBean("c7");
    Car c8 = (Car) iocContationer.getBean("c8");
    Car c9 = (Car) iocContationer.getBean("c9");
