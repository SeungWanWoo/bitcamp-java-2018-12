  ...
  public static void main(String[] args) {
    ApplicationContext iocContationer =
        new ClassPathXmlApplicationContext(
            "ch29/d/application-context-03.xml");
    
    System.out.println("------------------------------------");
    
    // 다른 객체의 프로퍼티에서 생성한 객체는 별도로 꺼낼 수 없다.
    //BlackBox bb1 = (BlackBox) iocContationer.getBean("bb1"); // 예외 발생!
    Car c1 = (Car) iocContationer.getBean("c1");
    //Car c2 = (Car) iocContationer.getBean("c2");
    Car c3 = (Car) iocContationer.getBean("c3");
