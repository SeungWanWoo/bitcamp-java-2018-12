...
public class Test19 {
  public static void main(String[] args) {
    ...
    // => 비트의 1또는 0을 이용하여 정보를 표현할 수 있다.
    //
    // 개발자가 프로그래밍 가능한 언어를 int 값으로 표현해보자!
    ...
    // ------------------------ (조사하려는 값에 0을 AND하면 무조건 0을 만든다.)
    //      0000 0000 0000 0000 (일치하는게 없다. 해당 사람은 TypeScript를 사용하지 않는다.)
    //                          (조사하려는 값에 1을 AND하면 원래 값 그대로 리턴한다.)
