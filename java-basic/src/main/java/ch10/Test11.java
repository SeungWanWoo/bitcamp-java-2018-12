...
class Monitor9 {
  ...
  Monitor9() {
    ...
    this.widthRes = 2560;
    this.heightRes = 1200;
    System.out.println("Monitor11()");
  }
  
  Monitor9(int bright, int contrast) {
    this.bright = bright;
    this.contrast = contrast;
    System.out.println("Monitor11(int, int)");
  }
  ...
  Monitor9(int bright, int contrast, int widthRes, int heightRes) {
    ...
    System.out.println("Monitor11(int, int, int, int)");
  }
