...
public class Test16 {
  public static void main(String[] args) throws Exception {
    ...
    Calendar c1;
    // 인스턴스를 생성할 수 없습니다. protected 객체이기 때문에
    // 그래서 같은 패키지 내에서만 사용할 수 있다.
    // 이 때문에 다른 패키지에 있는 Test16에서 사용할 수 없다.
    // 생성자가 있다 하더라도 접근 권한이 없으면 호출할 수 없다.
     ...
     *   - 인스턴스를 생성해주는 메서드이다.
     *   - 인스턴스 생성 과정이 복잡할 경우에 인스턴스를 생성해주는 메서드를 미리
     *     정의해 둔다.
