...
public class Test01 {
  public static void main(String[] args) {
    ...
    //    같은 식구가 된 Array는 LinkedList.this 라는 이름으로 바깥 클래스의
    //    인스턴스 주소를 사용할 수 있다.
    // 3) Array는 자기 것인양 LinkedList의 멤버를 사용하여 배열을 그대로 리턴한다.
 ...
 *    2) non-static 식구(inner class)
 *      => 그 집안(바깥 클래스)의 static 멤버 뿐만 아니라 non-static 멤버도 사용할 수 있다.
 *      
 *      non-static 멤버?
 *      => 인스턴스 필드, 인스턴스 필드, 인스턴스 생성자, 인스턴스 블록
