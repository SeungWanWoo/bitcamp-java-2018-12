...
public class Test03 {
  public static void main(String[] args) {
    ...
    => Object obj = (Object proxy, Method method, Object[] params) -> {
      return 0;
    }
     */
    ...
    Object proxyObj = (Calculator)Proxy.newProxyInstance(
       ...
       (Object proxy, Method method, Object[] params) -> {
            // newProxyInstance가 생성한 객체에 대해 메서드를 호출할 때마다 이 메서드가 호출된다.
    ...
    Calculator c1 = (Calculator) proxyObj;
    Calculator2 c2 = (Calculator2) proxyObj;
    Calculator3 c3 = (Calculator3) proxyObj;
