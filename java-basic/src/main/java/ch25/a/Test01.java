...
public class Test01 {
  public static void main(String[] args) {
    ...
    // => MariaDB의 JDBC드라이버에서 org.mariadb.jdbc.Driver 클래스가 이 구현체이다.
    
    try {
      DriverManager.registerDriver(new org.mariadb.jdbc.Driver());
    } catch (SQLException e) {
      System.out.println("MariaDB의 java.sql.Driver 구현체를 등록하는 중에"
          + "오류 발생!");
      e.printStackTrace();
    }
    ...
    //    - jdbcUrl => jdbc:(mariadb 또는 mysql)://서버주소:포트번호/데이터베이스 명
