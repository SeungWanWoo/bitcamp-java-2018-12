...
// App 객체의 상태 변경될 때 마다 보고 받는 옵저버가 되려면
// ApplicationContextListener 규격에 따라 작성해야 한다.
public class ApplicationInitailizer implements ApplicationContextListener {
  ...
  @Override
  public void contextDestryed(Map<String, Object> context) {
    try {
