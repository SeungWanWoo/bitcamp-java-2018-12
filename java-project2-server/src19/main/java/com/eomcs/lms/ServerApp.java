// 19단계: 애너테이션을 적용
// - IoC 컨테이너가 객체를 만들 때 클래스에서 객체 이름을 추출하기
//
  ...
  class RequestHandlerThread extends Thread {
    ...
    public void run() {
      try (Socket socket = this.socket;
        ...
        // 클라이언트에게 응답하기
        // => 클라이언트 요청을 처리할 객체는 빈 커네이너에서 꺼낸다.
